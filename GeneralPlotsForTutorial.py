...
plt.plot(dOrb,dDistance,"bo")
fig8.suptitle('Comparing Things and Stuff', fontsize = 17)
ax8.set_xlim(0, 2000)
ax8.set_ylim(0, 4000)
ax8.set_xlabel('Things', fontsize = 16)
ax8.set_ylabel('Stuff', fontsize = 16)
...
fig11.suptitle('Distribution of Stuff', fontsize = 18)
ax11.set_xlabel('Stuff', fontsize = 16)
ax11.set_ylabel('Frequency of Stuff', fontsize = 16)
plt.grid()
